# USECASE 07 — detached-no-auto-follow

Generated: 2026-08-09 (REVIEWED phase)

**Status**: REVIEWED (code-complete)

- Spec file: `e2e/usecase-07-detached-no-auto-follow.spec.ts`
- Drive: API
...
3. `bun run test:e2e -- e2e/usecase-07-detached-no-auto-follow.spec.ts` has not
...
3. `bash tastile-web/scripts/e2e/run-spec.sh 07` — writes JSON trace
