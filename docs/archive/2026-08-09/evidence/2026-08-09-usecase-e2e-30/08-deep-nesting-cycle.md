# USECASE 08 — deep-nesting-cycle

Generated: 2026-08-09 (REVIEWED phase)

**Status**: REVIEWED (code-complete)

- Spec file: `e2e/usecase-08-deep-nesting-cycle.spec.ts`
- Drive: UI
...
3. `bun run test:e2e -- e2e/usecase-08-deep-nesting-cycle.spec.ts` has not
...
3. `bash tastile-web/scripts/e2e/run-spec.sh 08` — writes JSON trace
