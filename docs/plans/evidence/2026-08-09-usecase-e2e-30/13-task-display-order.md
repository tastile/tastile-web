...
- Spec file: `e2e/usecase-13-task-display-order.spec.ts`
- Drive: UI
...
3. `bun run test:e2e -- e2e/usecase-13-task-display-order.spec.ts` has not
...
3. `bash tastile-web/scripts/e2e/run-spec.sh 13` — writes JSON trace
