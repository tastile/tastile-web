...
- Spec file: `e2e/usecase-14-template-update-frozen-execution.spec.ts`
- Drive: UI
...
3. `bun run test:e2e -- e2e/usecase-14-template-update-frozen-execution.spec.ts` has not
...
3. `bash tastile-web/scripts/e2e/run-spec.sh 14` — writes JSON trace
