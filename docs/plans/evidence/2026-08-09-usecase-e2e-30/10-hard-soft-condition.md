# USECASE 10 — hard-soft-condition

Generated: 2026-08-09 (REVIEWED phase)

**Status**: REVIEWED (code-complete)

- Spec file: `e2e/usecase-10-hard-soft-condition.spec.ts`
- Drive: UI
...
3. `bun run test:e2e -- e2e/usecase-10-hard-soft-condition.spec.ts` has not
...
3. `bash tastile-web/scripts/e2e/run-spec.sh 10` — writes JSON trace
