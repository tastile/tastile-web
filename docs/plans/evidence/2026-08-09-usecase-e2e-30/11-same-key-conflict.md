# USECASE 11 — same-key-conflict

Generated: 2026-08-09 (REVIEWED phase)

**Status**: REVIEWED (code-complete)

- Spec file: `e2e/usecase-11-same-key-conflict.spec.ts`
- Drive: API
...
3. `bun run test:e2e -- e2e/usecase-11-same-key-conflict.spec.ts` has not
...
3. `bash tastile-web/scripts/e2e/run-spec.sh 11` — writes JSON trace
