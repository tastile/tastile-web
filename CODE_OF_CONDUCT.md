...
reported to the community leaders responsible for enforcement via one of
these channels:

* Open a GitHub Issue on this repository, tagged `code-of-conduct`.
* Send an X (Twitter) DM to `@361do_sleep`.
...
individual, or aggression toward or disparagement of classes of the community.
