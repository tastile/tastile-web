 ...
 * (notably `ExecutionControls`) keep working unchanged.
 */

import { type V1ActiveTileSnapshot, fetchV1ActiveTile } from "@/shared/api/v1/active-tile";
import { queryKeys } from "@/shared/query/query-keys";
import { useQuery, useQueryClient } from "@tanstack/react-query";
import { useEffect } from "react";

export type { V1ActiveTileSnapshot } from "@/shared/api/v1/active-tile";
