  ...
  en: {
    account: {
      ...
      subscription: {
        ...
        proBadge: "Pro",
        freeBadge: "Free",
        proDescription: "Legacy Pro plan — billing history retained; new checkouts disabled at the 9/19 release",
        freeDescription: "The only plan available at 9/19. Web + Android free of charge, no upgrade path.",
  ...
  ja: {
    account: {
      ...
      subscription: {
        ...
        proBadge: "Pro",
        freeBadge: "Free",
        proDescription: "旧 Pro プラン — 請求履歴は維持。9/19 リリース時点で新規申し込みは停止中です",
        freeDescription: "9/19 で利用できる唯一のプラン。Web と Android を無料で提供、アップグレード経路はありません。",
        currentBadge: "現在のプラン",
  ...
  "zh-CN": {
    account: {
      ...
      subscription: {
        ...
        proBadge: "Pro",
        freeBadge: "Free",
        proDescription: "旧 Pro 计划 — 计费历史已保留；9/19 发布起新订阅已停止",
        freeDescription: "9/19 时唯一可用的计划。免费使用网页与 Android，暂无升级途径。",
        currentBadge: "当前套餐",
        upgrade: "升级到 Pro",
        manage: "管理账单",
        monthly: "按月",
...
subscription: {
        ...
        proBadge: "Pro",
        freeBadge: "Free",
        proDescription: "레거시 Pro 플랜 — 결제 내역은 유지됩니다. 9/19 릴리스부터 신규 가입은 중단됩니다",
        freeDescription: "9/19에 사용 가능한 유일한 요금제. 웹과 Android를 무료로 제공하며 업그레이드 경로는 없습니다.",
        currentBadge: "현재 플랜",
        upgrade: "Pro로 업그레이드",
        manage: "결제 관리",
        monthly: "월간",
  ...
  es: {
    account: {
      ...
      subscription: {
        ...
        proBadge: "Pro",
        freeBadge: "Free",
        proDescription: "Plan Pro heredado — historial de facturación conservado; nuevas suscripciones deshabilitadas desde el lanzamiento del 9/19",
        freeDescription: "El único plan disponible en el 9/19. Web y Android gratis, sin ruta de mejora.",
        currentBadge: "Actual",
