  ...
  ja: {
      ...
      timeline: [
        {
          time: "09:00",
          title: "資料を仕上げる",
          note: "スタジオで60分。集中モード起動、通知を自動で抑える。",
          kind: "tile",
        },
        {
          time: "09:35",
          title: "前倒し調整",
          note: "進捗が予定より早い。次のタイルを5分前倒し。",
          kind: "adjust",
        },
        {
          time: "10:30",
          title: "メールを片付ける",
          note: "20分の予定。場所は「どこでも」。移動中にも実行可能。",
          kind: "tile",
        },
        {
          time: "11:00",
          title: "超過処理",
          note: "想定外の30分かかる。残り10分は12:00の空き枠へ。",
          kind: "overflow",
        },
        {
          time: "12:00",
          title: "外を歩く",
          note: "屋外で30分。通知は自動で抑えたまま。",
          kind: "break",
        },
        {
          time: "13:00",
          title: "リリースノートを書く",
          note: "スタジオで45分。資料を開く動作も自動化。",
          kind: "tile",
        },
        {
          time: "18:00",
          title: "観測と調整",
          note: "今日の実行パターンを記録。翌朝の配置精度が上がる。",
          kind: "adjust",
        },
      ],
    },
    ...
    faq: {
      ...
      items: [
        {
          q: "既存のアプリと、何が違う？",
          a: "カレンダー・時計・タスクを一つにする。アプリを切り替える動作が、なくなる。予定を立てるのではなく、タイルが動く。",
        },
        {
          q: "スケジュールが変わったら？",
          a: "自動で組み直される。遅れた場合も、空き時間ができた場合も、エンジンが即座に再配置する。手動で直す必要はない。",
        },
        {
          q: "タスクが終わらなかったら？",
          a: "次の空き時間に自動で入る。残り5分でも、翌日でも、履歴として残しつつ、積み残さず次へ流す。タスクが消えることはない。",
        },
        {
          q: "どんな人に向いている？",
          a: "「何から始めよう」と悩む時間を減らしたい人。1日の中でタスクが散らばる人。実行そのものに向き合いたい人。",
        },
        {
          q: "データは誰が持っていますか？",
          a: "あなたが持つ。エクスポート機能ですべての履歴と設定を取り出せる。削除も完全に行える。",
        },
        {
          q: "オフラインで使えますか？",
          a: "Web版は基本オンライン。デスクトップ版はオフライン動作に対応し、再接続時に同期する。",
        },
        {
          q: "Googleカレンダーと連携できますか？",
          a: "Proでは双向同期に対応する予定。固定の予定はタイルとして取り込める。",
        },
        {
          q: "解約はいつでもできますか？",
          a: "いつでも。解約後も履歴は残り、Freeに戻って引き続き利用できる。",
        },
      ],
    },
    finalCta: {
      ...
      timeline: [
        {
          time: "09:00",
          title: "Finish the deck",
          note: "Studio, 60 minutes. Focus mode on, notifications silenced.",
          kind: "tile",
        },
        {
          time: "09:35",
          title: "Pull-ahead adjustment",
          note: "Running ahead of schedule. Next tile pulled up by 5 minutes.",
          kind: "adjust",
        },
        {
          time: "10:30",
          title: "Clear inbox",
          note: "20 minutes, place: anywhere. Runs in transit.",
          kind: "tile",
        },
        {
          time: "11:00",
          title: "Overflow",
          note: "Unexpected 30 minutes. The leftover 10 slots into 12:00.",
          kind: "overflow",
        },
        {
          time: "12:00",
          title: "Walk, no phone",
          note: "Outdoors, 30 minutes. Notifications stay silenced.",
          kind: "break",
        },
        {
          time: "13:00",
          title: "Draft release notes",
          note: "Studio, 45 minutes. The deck opens automatically.",
          kind: "tile",
        },
        {
          time: "18:00",
          title: "Observe and adjust",
          note: "Today's pattern is logged. Tomorrow morning gets sharper.",
          kind: "adjust",
        },
      ],
    },
      ...
      items: [
        {
          ...
          a: "Calendar, clock, and tasks, in one place. No more switching apps. You do not plan — the tile moves.",
        },
        {
          q: "What if the schedule changes?",
          a: "The engine rebuilds it. Slip or a new opening, either way the schedule reshapes instantly. No manual edits.",
        },
        {
          q: "What if I do not finish a task?",
          a: "The leftover rolls into the next open slot. Five minutes or five hours, the history keeps the record, and nothing is dropped.",
        },
        {
          q: "Who is this for?",
          a: "Anyone who wants to spend less time planning and more time executing. Anyone whose tasks scatter across the day. Anyone ready to face the work itself.",
        },
        {
          q: "Who owns the data?",
          a: "You do. Export every event and setting. Delete fully, any time.",
        },
        {
          q: "Does it work offline?",
          a: "The web app needs a connection. The desktop client works offline and syncs when it comes back.",
        },
        {
          q: "Can it sync with my calendar?",
          a: "Two-way Google Calendar sync is on the Pro roadmap. Fixed events come in as tiles.",
        },
        {
          q: "Can I cancel anytime?",
          a: "Anytime. After cancelling, history stays and you keep using Free.",
        },
      ],
    },
    finalCta: {
