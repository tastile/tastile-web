				...
				<header className="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:gap-16 lg:items-end">
					...
					<div className="lg:pb-2">
						...
						<div className="mt-6 flex items-center gap-3">
							...
							<span className={`text-[11px] font-medium uppercase tracking-[0.22em] text-primary ${display}`}>
								{t.activeLabel}
							</span>
						</div>
					</div>
								...
								<div className="flex flex-col items-start">
									...
									<span
										className={`mt-2 inline-block h-2 w-2 rounded-full ${
											i === ACTIVE_INDEX
												? "bg-primary mkt-pulse-dot"
												: "bg-surface-2"
										}`}
									/>
								</div>
								<div className="min-w-0">
									<h3 className={`text-xl font-semibold tracking-tight text-foreground lg:text-2xl ${display}`}>
										{phase.title}
									</h3>
