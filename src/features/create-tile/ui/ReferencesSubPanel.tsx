...
export function ReferencesSubPanel({
  ...
  const [referencePickerIndex, setReferencePickerIndex] = useState<
    number | null
  >(null);
      ...
      <FormPanel>
        ...
        <div className="flex flex-col gap-4">
          {plan.references.map((ref, index) => {
            ...
            const hasTarget =
              ref.target.referenceId !== null && ref.target.referenceId !== "";
            const intervalValue = (() => {
                ...
                >
                  <div className="flex flex-col gap-1">
                    ...
                    >
                      {hasTarget
                        ? ref.target.referenceId
                        : t("quickCreate.referenceIdPlaceholder")}
                    </Button>
                  </div>
                </FormRow>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <SegmentedControl
                      ...
                      onChange={(next) => {
                        ...
                        updated[index] = {
                          ...ref,
                          pick: { ...ref.pick, kind: Number(next) },
                        };
                      ...
                      data={[
                        ...
                        {
                          value: "1",
                          label: t("quickCreate.referenceRelationFirst"),
                        },
                        {
                          value: "2",
                          label: t("quickCreate.referenceRelationLast"),
                        },
                        {
                          value: "0",
                          label: t("quickCreate.referenceRelationAll"),
                        },
                      ]}
                    ...
                    >
                      <NumberInput
                        ...
                        onChange={(value) => {
                          ...
                          updated[index] = {
                            ...ref,
                            pick: { ...ref.pick, momentId: String(next) },
                          };
                          setField("plan.references", updated);
                        }}
                        size="xs"
        ...
        <TileReferencePicker
          ...
          currentValue={
            referencePickerIndex !== null
              ? (plan.references[referencePickerIndex]?.target.referenceId ??
                null)
              : null
          }
        />
