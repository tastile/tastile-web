    ...
    <Stack gap="md" p="md">
      <FormRow icon={null}>
        <div className="flex flex-col gap-1">
          <span className="text-xs font-medium">{t("quickCreate.panel.sourceWindow.heading")}</span>
      ...
      <FormRow icon={null}>
        <div className="flex flex-col gap-1">
          <span className="text-xs font-medium">{t("quickCreate.panel.sourceWindow.placementPriorityLabel")}</span>
          <NumberInput
      ...
      <FormRow icon={<XCircle className="size-4" aria-hidden />} className="items-start">
        <div className="flex flex-col gap-1">
          ...
          <TagsInput
            description={t("quickCreate.panel.sourceWindow.excludedDatesDescription")}
            placeholder={t("quickCreate.panel.sourceWindow.excludedDatesPlaceholder")}
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            <Select
              ...
              data={[
                { value: "0", label: t("quickCreate.panel.sourceWindow.splitUnsplit") },
              ]}
