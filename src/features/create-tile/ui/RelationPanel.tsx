...
import {
  type SourceTileRead,
  listSourceTiles,
} from "@/shared/api/v1/source-tiles";
      ...
      <FormRow icon={<Network className="size-4" aria-hidden />}>
        <div className="flex flex-col gap-1">
          <span className="text-xs font-medium">
            {t("quickCreate.panel.relations.heading")}
          </span>
      ...
      {relations.map((relation, index) => (
        ...
        >
          <Group justify="space-between">
            <Text fw={600} size="xs">
              {t("quickCreate.panel.relations.relationIndexLabel", {
                index: index + 1,
              })}
            </Text>
            <ActionIcon
              ...
              onClick={() =>
                setRelations(
                  relations.filter((item) => item.id !== relation.id),
                )
              }
            >
              <Trash2 size={15} />
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium">
                {t("quickCreate.panel.relations.referencedSourceLabel")}
              </span>
              <Select
                searchable
                ...
                onChange={(value) => {
                  const source = sources.find(
                    (item) => item.source_tile_id === value,
                  );
                  update(relation.id, {
                ...
                aria-label={t(
                  "quickCreate.panel.relations.referencedSourceLabel",
                )}
              />
            </div>
          </FormRow>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium">
                {t("quickCreate.panel.relations.relationKindLabel")}
              </span>
              <Select
                ...
                data={[
                  {
                    value: "0",
                    label: t("quickCreate.panel.relations.kindInside"),
                  },
                  {
                    value: "1",
                    label: t("quickCreate.panel.relations.kindBefore"),
                  },
                  {
                    value: "2",
                    label: t("quickCreate.panel.relations.kindAfter"),
                  },
                  {
                    value: "3",
                    label: t("quickCreate.panel.relations.kindStartsAt"),
                  },
                  {
                    value: "4",
                    label: t("quickCreate.panel.relations.kindEndsAt"),
                  },
                  {
                    value: "5",
                    label: t("quickCreate.panel.relations.kindSameSpan"),
                  },
                  {
                    value: "6",
                    label: t("quickCreate.panel.relations.kindSameDuration"),
                  },
                ]}
                onChange={(value) =>
                  update(relation.id, { kind: Number(value) })
                }
                aria-label={t("quickCreate.panel.relations.relationKindLabel")}
              />
            </div>
          </FormRow>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium">
                {t("quickCreate.panel.relations.offsetPriorityLabel")}
              </span>
              <Group grow>
                <NumberInput
                  ...
                  onChange={(value) =>
                    update(relation.id, {
                      offsetMs: (Number(value) || 0) * 60_000,
                    })
                  }
                />
                <NumberInput
                  ...
                  onChange={(value) =>
                    update(relation.id, { summaryPriority: Number(value) || 0 })
                  }
                />
              </Group>
            </div>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium">
                {t("quickCreate.panel.relations.durationLabel")}
              </span>
              <Select
                ...
                data={[
                  {
                    value: "subject",
                    label: t("quickCreate.panel.relations.durationSubject"),
                  },
                  {
                    value: "reference",
                    label: t("quickCreate.panel.relations.durationReference"),
                  },
                  {
                    value: "fixed",
                    label: t("quickCreate.panel.relations.durationFixed"),
                  },
                ]}
                onChange={(value) =>
                  update(relation.id, {
                    durationKind: (value ??
                      "subject") as SourceRelationDraft["durationKind"],
                  })
                }
                aria-label={t("quickCreate.panel.relations.durationLabel")}
              />
            </div>
          </FormRow>
          ...
          {relation.durationKind === "fixed" ? (
            ...
            >
              <div className="flex flex-col gap-1">
                <span className="text-xs font-medium">
                  {t("quickCreate.panel.relations.fixedMinutesLabel")}
                </span>
                <NumberInput
                  min={1}
                  ...
                  onChange={(value) =>
                    update(relation.id, {
                      fixedDurationMs: (Number(value) || 0) * 60_000,
                    })
                  }
                />
              </div>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium">
                {t("quickCreate.panel.relations.allocationSplitLabel")}
              </span>
              <Select
                ...
                data={[
                  {
                    value: "unsplit",
                    label: t("quickCreate.panel.relations.splitUnsplit"),
                  },
                  {
                    value: "split",
                    label: t("quickCreate.panel.relations.splitMultiple"),
                  },
                ]}
                onChange={(value) =>
                  update(relation.id, {
                ...
                aria-label={t(
                  "quickCreate.panel.relations.allocationSplitLabel",
                )}
              />
            </div>
          </FormRow>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-xs font-medium">
                {t("quickCreate.panel.relations.totalAllocationLabel")}
              </span>
              <NumberInput
                min={1}
          ...
          {relation.splitPolicy.kind === "split" ? (
            ...
            >
              <div className="flex flex-col gap-1">
                <span className="text-xs font-medium">
                  {t("quickCreate.panel.relations.splitSettingsLabel")}
                </span>
                <Group grow>
                  <NumberInput
