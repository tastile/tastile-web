import { Button, ColorInput, Modal, Select, TextInput } from "@mantine/core";
...
export function CreateProjectModal({
  ...
  const [newProjectParentId, setNewProjectParentId] = useState<string | null>(
    null,
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        {newProjectError && (
          <span role="alert" className="text-caption text-status-danger">
            {newProjectError}
          </span>
        )}
      </form>
