			...
			<FormRow icon={<Scale className="size-4" aria-hidden />}>
				<div className="flex flex-col gap-1">
					<span className="text-xs font-medium">
						{t("quickCreate.panel.placementRules.heading")}
					</span>
			...
			{rules.map((rule, index) => (
				...
				>
					<Group justify="space-between">
						<Text fw={600} size="xs">
							{t("quickCreate.panel.placementRules.ruleIndexLabel", {
								index: index + 1,
							})}
						</Text>
						<ActionIcon
					...
					>
						<div className="flex flex-col gap-1">
							<span className="text-xs font-medium">
								{t("quickCreate.panel.placementRules.effectRankLabel")}
							</span>
							<Group grow>
								<Select
									...
									data={[
										{
											value: "0",
											label: t("quickCreate.panel.placementRules.effectPermit"),
										},
										{
											value: "1",
											label: t("quickCreate.panel.placementRules.effectDeny"),
										},
										{
											value: "2",
											label: t("quickCreate.panel.placementRules.effectLimit"),
										},
										{
											value: "3",
											label: t("quickCreate.panel.placementRules.effectScore"),
										},
										{
											value: "4",
											label: t("quickCreate.panel.placementRules.effectRecord"),
										},
									]}
									onChange={(value) =>
										update(rule.id, {
								...
								<NumberInput
									...
									value={rule.rank}
									onChange={(value) =>
										update(rule.id, { rank: Number(value) || 0 })
									}
								/>
							</Group>
						</div>
						...
						>
							<div className="flex flex-col gap-1">
								<div className="flex items-center justify-between">
									<span className="text-xs font-medium">
										{t("quickCreate.panel.placementRules.conditionLabel")}
									</span>
									<Button
										size="compact-xs"
										variant="outline"
					...
					{rule.effect.kind === 2 ? (
						...
						>
							<div className="flex flex-col gap-1">
								<span className="text-xs font-medium">
									{t("quickCreate.panel.placementRules.timeLimitLabel")}
								</span>
								<Group grow>
									<NumberInput
					...
					{rule.effect.kind === 3 ? (
						...
						>
							<div className="flex flex-col gap-1">
								<span className="text-xs font-medium">
									{t("quickCreate.panel.placementRules.scoreLabel")}
								</span>
								<NumberInput
					...
					{rule.effect.kind === 4 ? (
						...
						>
							<div className="flex flex-col gap-1">
								<span className="text-xs font-medium">
									{t("quickCreate.panel.placementRules.executionRecordLabel")}
								</span>
								<Select
									...
									data={[
										{
											value: "0",
											label: t(
												"quickCreate.panel.placementRules.recordOptional",
											),
										},
										{
											value: "1",
											label: t(
												"quickCreate.panel.placementRules.recordRequired",
											),
										},
									]}
									onChange={(value) =>
