...
export async function getCognitoUser(env: CognitoEnv, accessToken: string): Promise<CognitoUserProfile> {
  const response = await cognitoRequest(env, 'GetUser', { AccessToken: accessToken })
