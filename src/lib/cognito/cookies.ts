...
export async function setAuthCookies(args: SetAuthCookiesArgs, response?: NextResponse): Promise<void> {
  ...
  if (args.accessToken) {
    jar.set(COOKIE_ACCESS_TOKEN, args.accessToken, { ...baseOptions, maxAge: args.expiresIn })
  }
...
export async function clearAuthCookies(): Promise<void> {
  ...
  for (const name of [COOKIE_ID_TOKEN, COOKIE_ACCESS_TOKEN, COOKIE_REFRESH_TOKEN, COOKIE_USER_SUB, COOKIE_EMAIL_AUTH_SESSION, COOKIE_EMAIL_AUTH_USERNAME]) {
