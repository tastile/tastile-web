...
import { DragContext, type DragContextValue } from "../DragContext/DragContext";
import {
  type RenderEvent,
...
import { type WeekViewControlsRef, handleWeekViewKeyDown } from "./handle-week-view-key-down";
...
WeekView.displayName = "@/lib/vendored/mantine-schedule/WeekView";
