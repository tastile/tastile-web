...
import { type ScheduleLabelsOverride, getLabel } from "../../labels";
import type {
  AnyDateValue,
  DateLabelFormat,
  DateStringValue,
...
import {
  ...
  type CurrentTimeIndicatorStylesNames,
} from "../CurrentTimeIndicator/CurrentTimeIndicator";
import { DragContext } from "../DragContext/DragContext";
import {
  MoreEvents,
  type MoreEventsProps,
  type MoreEventsStylesNames,
} from "../MoreEvents/MoreEvents";
import {
  type RenderEvent,
  type RenderEventBody,
  ScheduleEvent,
  type ScheduleEventStylesNames,
} from "../ScheduleEvent/ScheduleEvent";
import type { MonthYearSelectStylesNames } from "../ScheduleHeader/MonthYearSelect/MonthYearSelect";
...
DayView.displayName = "@/lib/vendored/mantine-schedule/DayView";
