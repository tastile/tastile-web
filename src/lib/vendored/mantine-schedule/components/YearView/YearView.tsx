...
import { YearViewMonth, type YearViewMonthSettings } from "./YearViewMonth";
...
import { type YearViewControlsRef, handleYearViewKeyDown } from "./handle-year-view-key-down";
...
YearView.displayName = "@/lib/vendored/mantine-schedule/YearView";
