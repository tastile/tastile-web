...
import { DayView, type DayViewProps, type DayViewStylesNames } from "../DayView/DayView";
import {
  MobileMonthView,
  type MobileMonthViewProps,
  type MobileMonthViewStylesNames,
} from "../MobileMonthView/MobileMonthView";
import { MonthView, type MonthViewProps, type MonthViewStylesNames } from "../MonthView/MonthView";
import type { RenderEventBody } from "../ScheduleEvent/ScheduleEvent";
import { WeekView, type WeekViewProps, type WeekViewStylesNames } from "../WeekView/WeekView";
import { YearView, type YearViewProps, type YearViewStylesNames } from "../YearView/YearView";
...
Schedule.displayName = "@/lib/vendored/mantine-schedule/Schedule";
