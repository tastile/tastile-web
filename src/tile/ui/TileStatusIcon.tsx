...
export function TileStatusIcon({
	...
	return (
		<ActionIcon
			...
			className={cn(
				"flex shrink-0 items-center justify-center rounded-full transition-[box-shadow] duration-200 ease-in-out relative",
				!disabled &&
					onClick &&
		...
		>
			{lifecycle === "started" && (
				<div className="absolute inset-0 rounded-full bg-current motion-safe:animate-ping opacity-75" />
			)}
