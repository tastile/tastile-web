...
const dict = {
  ...
  en: {
    ...
    proPrice: "$6",
    proPer: "/mo",
    proSub: "Annual billing: $48/yr (save 2 months)",
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 flex flex-col lg:flex-row items-start gap-16">
        ...
        <div className="flex-1 w-full">
          <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 p-6 space-y-3">
            <p className="text-xs font-mono text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mb-4">{t.demoLabel}</p>
      ...
      <section id="features" className="bg-zinc-50 dark:bg-zinc-900 py-24">
        <div className="mx-auto max-w-7xl px-6">
          <h2 className="text-3xl font-bold font-mono text-zinc-900 dark:text-zinc-100 mb-4">{t.pillarsTitle}</h2>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          <h2 className="text-3xl font-bold font-mono text-zinc-900 dark:text-zinc-100 mb-4">{t.stepsTitle}</h2>
      ...
      <section className="bg-zinc-50 dark:bg-zinc-900 py-24">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="text-3xl font-bold font-mono text-zinc-900 dark:text-zinc-100 mb-3">{t.pricingTitle}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 p-8">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-2xl font-bold font-mono text-zinc-900 dark:text-zinc-100">{t.freeLabel}</span>
              </div>
            ...
            <div className="rounded-2xl bg-zinc-900 dark:bg-zinc-100 p-8">
              <div className="flex items-baseline gap-2 mb-1">
                ...
                <span className="text-lg font-mono text-zinc-300 dark:text-zinc-600">{t.proPrice}</span>
