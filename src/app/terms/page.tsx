      ...
      <main className="flex-1">
        <div className="layout-shell max-w-3xl py-12">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <h2 className="mt-8 mb-4 text-xl font-[590] text-foreground">1. Account Terms</h2>
            ...
            <h2 className="mt-8 mb-4 text-xl font-[590] text-foreground">2. Acceptable Use</h2>
            <p className="text-foreground-muted">
            ...
            <h2 className="mt-8 mb-4 text-xl font-[590] text-foreground">3. Billing and Refunds</h2>
            <p className="text-foreground-muted">
            ...
            <h2 className="mt-8 mb-4 text-xl font-[590] text-foreground">5. Termination</h2>
            <p className="text-foreground-muted">
            ...
            <h2 className="mt-8 mb-4 text-xl font-[590] text-foreground">6. Changes to Terms</h2>
            <p className="text-foreground-muted">
