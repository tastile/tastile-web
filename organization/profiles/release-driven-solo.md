...
- workspace contract and Tastile Core v1 domain/API remain upstream authorities for cross-repo behavior.
- Next.js/React/Bun/Cloudflare/AWS auth decisions in repository ADRs remain project-specific Practices.
- browser/E2E/deployment evidence must be bound to the current candidate SHA/artifact.
...
- project-local only; global install is not canonical
- commit CLI-generated `skills-lock.json`; do not hand-edit source/hash
- keep project-specific refinement outside upstream-managed Skill files
